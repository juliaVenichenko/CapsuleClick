...
public class GameResources {
    ...
    // Фоны
    public static final String BACKGROUND_DEFAULT = "backgrounds/background_default.png";
    public static final String BACKGROUND_SHOP = "backgrounds/background_shop.png";
    public static final String BACKGROUND_EPIC = "backgrounds/background_epic.png";
    ...
    public static final String CAPSULE_BLUE = "capsule_skins/capsule_blue.png";
    public static final String CAPSULE_GREEN = "capsule_skins/capsule_green.png";
    public static final String CAPSULE_ORANGE = "capsule_skins/capsule_orange.png";
    public static final String CAPSULE_PLUM = "capsule_skins/capsule_plum.png";
    public static final String CAPSULE_RED = "capsule_skins/capsule_red.png";
    public static final String CAPSULE_YELLOW = "capsule_skins/capsule_yellow.png";

    // Шапки
    public static final String HAT_NULL = "hats/null.png";
    ...
    public static final String ICON_COLOR_ORANGE = "icons/shop/colors/orange.png";
    public static final String ICON_COLOR_RED = "icons/shop/colors/red.png";
